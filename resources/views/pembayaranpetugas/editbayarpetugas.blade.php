...
@section('container')
    <div class="container">
        <div class="card shadow">
            <div class="card-body">
                <h3 class="h3"><i class="fa-sharp fa-solid fa-money-bill-transfer"></i> Tamabah Data Pembayaran</h3>
                <div class="col-md-6">
                    <div class="card border-dark">
                        <div class="card-body">
                            <form action="/pembayaranpetugas/{{ $datapembayaran->id }}" method="POST">
                                @method('PUT')
                                @csrf
