...
<title>Menambah Data Petugas</title>
@section('container')
    <div class="container">
        <div class="card shadow">
            <div class="card-body">
                <h3 class="h3"><i class="fa-sharp fa-solid fa-users"></i> Tamabah Data Petugas</h3>
                <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <form action="/datapetugas" method="POST">
                                ...
                                <div class="form-group">
                                    <h6><label for="name">Masukkan</label></h6>
                                    <input type="text" name="name" class="form-control" placeholder="Nama"
                                        autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <h6><label for="email">Masukkan</label></h6>
                                ...
                                <div class="form-group">
                                    <h6><label for="level">Jenis Kelamin</label></h6>
                                ...
                                <div class="form-group">
                                    <h6><label for="username">Masukkan</label></h6>
                                    <input type="text" name="username" class="form-control" placeholder="Username"
                                        autocomplete="off">
                                </div>
                                <div class="form-group mt-1">
                                    <a href="/datapetugas" class="btn btn-danger mt-3"><svg
