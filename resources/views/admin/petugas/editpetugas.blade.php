...
@section('container')
    <div class="container">
        <div class="card shadow">
            <div class="card-body">
                <h3 class="h3"><i class="fa-sharp fa-solid fa-users"></i> Edit Data Petugas</h3>
                <div class="col-md-6">
                    <div class="card border-dark">
                        <div class="card-body">
                            <form action="/editpetugas" method="POST">
                                ...
                                <div class="form-group">
                                    <h6><label for="name">Nama petugas</label></h6>
                                ...
                                <div class="form-group">
                                    <h6><label for="no_telp">Telpon</label></h6>
                                    <input type="text" name="no_telp" class="form-control" placeholder=""
                                        autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <h6><label for="role">Role</label></h6>
