...
@section('container')
    <div class="container">
        <div class="card shadow">
            <div class="card-body">
                <h3 class="h3"><i class="fa-sharp fa-solid fa-graduation-cap"></i> Edit Data Siswa</h3>
                <div class="col-md-6">
                    <div class="card border-dark">
                        <div class="card-body">
                            <form action="/datasiswa/{{ $datasiswa->nisn }}" method="POST">
                                @method('PUT')
                                @csrf
                                <div class="form-group">
                                    <h6><label for="nisn">Masukkan</label></h6>
                                    <input type="text" name="nisn" class="form-control" placeholder="Nisn"
                                        autocomplete="off" value="{{ $datasiswa->nisn }}">
                                </div>
                                <div class="form-group">
                                    <h6><label for="nis">Masukkan</label></h6>
                                    <input type="text" name="nis" class="form-control" placeholder="Nis"
                                        autocomplete="off" value="{{ $datasiswa->nis }}">
                                </div>
                                <div class="form-group">
                                    <h6><label for="nama_siswa">Masukkan</label></h6>
                                    <input type="text" name="nama_siswa" class="form-control" placeholder="Nama Siswa"
                                        autocomplete="off" value="{{ $datasiswa->nama_siswa }}">
                                </div>
                                <div class="mt-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alamat" class="form-control" placeholder="Alamat"
                                        autocomplete="off" value="{{ $datasiswa->alamat }}">
                                </div>
                                <div class="form-group">
