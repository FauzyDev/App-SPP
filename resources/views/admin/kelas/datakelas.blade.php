...
@section('container')
    <div class="container">
        <div class="card shadow">
            <div class="card-body">
                <h3 class="h3 text-dark text-bold"><i class="fa-sharp fa-solid fa-school"></i> Data Kelas</h3>
                @if (session()->has('informasi'))
                    <div class="alert alert-success">
                        {{ session('informasi') }}
                    </div>
                @endif
                <a href="/datakelas/create"><button class="btn btn-primary mt-3 mb-4" type="submit"><i
                ...
                <table class="table table-responsiv table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $kelas->tingkatan }}</td>
                        <td class="text-center">{{ $kelas->nama_kelas }}</td>
                        <td class="text-center">
                            <a href="/datakelas/{{ $kelas->id }}/edit" class="btn btn-primary btn-sm mx-2"><i
